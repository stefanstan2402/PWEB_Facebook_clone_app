...
export const useUserTableController = () => {
    const { getUsers: { key: queryKey, query }, deleteUser: { key: deleteUserKey, mutation: deleteUser }, updateUser: { key: updateUserKey, mutation: updateUser } } = useUserApi(); // Use the API hook.
