...
export const useLoginFormController = (): LoginFormController => {
    ...
    const routeToCreateAccount = useCallback(() => { // Create a callback to route to the create account page.
        redirectToHome();
    }, [redirectToHome]);
    ...
    return {
        actions: { // Return any callbacks needed to interact with the form.
            ...
            register,
            routeToCreateAccount: routeToCreateAccount // Add a route to the create account page.
             // Add the variable register to bind the form fields in the UI with the form variables.,
        },
        computed: {
            defaultValues,
