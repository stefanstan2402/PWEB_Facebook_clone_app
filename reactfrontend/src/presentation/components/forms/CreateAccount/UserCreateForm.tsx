...
import { useUserCreateFormController } from "./UserCreateForm.controller";
 ...
 */
export const UserCreateForm = (props: { onSubmit?: () => void }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useUserCreateFormController(props.onSubmit); // Use the controller.
