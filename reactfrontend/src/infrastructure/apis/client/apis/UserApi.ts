...
import {
    ...
    UserRequestResponseFromJSON,
    UserRequestResponseToJSON,
...
export interface ApiUserGetByEmailMailEmailGetRequest {
    email: string;
}
...
export class UserApi extends runtime.BaseAPI {
    ...
    /**
     */
    async apiUserGetByEmailMailEmailGetRaw(requestParameters: ApiUserGetByEmailMailEmailGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserRequestResponse>> {
        if (requestParameters.email === null || requestParameters.email === undefined) {
            throw new runtime.RequiredError('email','Required parameter requestParameters.email was null or undefined when calling apiUserGetByEmailMailEmailGet.');
        }
        ...
        const response = await this.request({
            path: `/api/User/GetByEmail/mail/{email}`.replace(`{${"email"}}`, encodeURIComponent(String(requestParameters.email))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UserRequestResponseFromJSON(jsonValue));
    }

    /**
     */
    async apiUserGetByEmailMailEmailGet(requestParameters: ApiUserGetByEmailMailEmailGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserRequestResponse> {
        const response = await this.apiUserGetByEmailMailEmailGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
